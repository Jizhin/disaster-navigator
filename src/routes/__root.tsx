...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Real-time community reporting platform for floods, landslides, road damage, power failures and public safety incidents across Kerala." },
      { property: "og:title", content: "Anything Happened? — Kerala Community Disaster Watch" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;700;800&family=Work+Sans:wght@300;400;500;600;700&display=swap" },
